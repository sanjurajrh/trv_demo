...
#
# CHANGELOG
# * Jul 12 2022 Bernardo Gargallo <bgargallo@redhat.com>
#   - original code
...
# * Feb 01 2023 Alex Callejas <acalleja@redhat.com>
...
Network Network Red Hat Content guided exercise.
"""
...
_satellite_host2 = ["satellite"]
_capsule_host = ["capsule"]
_capsule_host2 = "capsule"
...
_file_name = "satellite-installer-example.txt"
_file_loc = _basedir + _file_name
_dest = "/root/"

_subnet = "Boston Data Center"
_domain = "boston.lab.example.com"


labname = 'network-network'

# Change the class name to match your file name.


class NetworkNetwork(GuidedExercise):
    """Activity class."""
    __LAB__ = labname
    ...
    def start(self):
        ...
        items = [
            ...
            newcourselib.check_ports(_satellite_host2, _ports_satellite),
            ...
            newcourselib.copy_file(_capsule_host2, _file_loc, _dest),

...
#   - original code
# * Jun 29 2022 Bernardo Gargallo <bgargallo@redhat.com>
#   - change CV
...
_cv_boston_project = "Boston HA Project"
...
labname = 'capsule-views'

# Change the class name to match your file name.


class CapsuleViews(GuidedExercise):
    """Activity class."""
    __LAB__ = labname
    ...
    def start(self):
        ...
        items = [
            ...
            newcourselib.remove_lifecycle_cv(_orgname_ops, _cv_boston_project, _lcdev),
            newcourselib.remove_lifecycle_cv(_orgname_ops, _cv_boston_project, _lclib),
            newcourselib.remove_cv(_orgname_ops, _cv_boston_project),
        ]

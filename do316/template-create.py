...
#
# CHANGELOG
# * Apr 20 2022 Natalie Lind <nlind@redhat.com>
#   - original code

"""
Grading module for DO316 template-create guided exercise.
This module either does start or finish for the template-create guided exercise.
"""
...
class TemplateCreate(OpenShift):
    """
    Template Create GE script for DO316
    """

    __LAB__ = "template-create"
    ...
    def start(self):
        ...
        items = [
            ...
            {
                "label": "Updating default storage class profile",
                "task": self.run_playbook,
                "playbook": f"ansible/{self.__LAB__}/update-nfs-storage.yml",
                "fatal": True,
            },
            {
    ...
    def finish(self):
        ...
        items = [
            ...
            {
                "label": "Reverting storage class defaults",
                "task": self.run_playbook,
                "playbook": f"ansible/{self.__LAB__}/revert-nfs-storage.yml",
                "fatal": True,
            },
            {
    ...
    def _create_project(self, item):
        ...
        try:
            ...
            item["msgs"] = [
                {
                    "text": "Could not create the project, please run the finish function to cleanup the environment"
                }
            ]
            item["exception"] = {

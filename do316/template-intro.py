...
#
# CHANGELOG
# * Apr 12 2022 Natalie Lind <nlind@redhat.com>
#   - original code

"""
Grading module for DO316 template-intro guided exercise.
This module either does start and finish for the template-intro guided exercise.
"""
...
class TemplateIntro(OpenShift):
    """
    Template Intro GE script for DO316
    """

    __LAB__ = "template-intro"
    ...
    def start(self):
        ...
        items = [
            ...
            },
            {
                ...
                "playbook": "ansible/template-intro/resources.yml",
                "fatal": True,
            },
            {
    ...
    def finish(self):
        ...
        items = [
            ...
            {
                "label": f"Deleting the {DV_NAMESPACE} and {NAMESPACE} projects",
    ...
    def _delete_ge_namespace(self, item):
        ...
        if not item["failed"]:
            ...
            time.sleep(60)
        try:
            self.delete_resource("v1", "Namespace", (DV_NAMESPACE), "")
        except Exception as e:
            item["failed"] = True
            item["msgs"] = [
                {"text": "Failed removing namespace %s: %s" % (DV_NAMESPACE, e)}
            ]
        if not item["failed"]:
            # Give time for the namespace to terminate
            time.sleep(60)

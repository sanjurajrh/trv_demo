...
#
# CHANGELOG
# * Mar 22 2022 Herve Quatremain <hquatrem@redhat.com>
#   Original code
# - Mar 26 2024 Andres Hernandez <andres.hernandez@redhat.com>
#   Version bump to OCP 4.14

"""
Grading module for DO316 storage-multiple lab.
This module either does start or finish for the storage-multiple lab.
"""
...
class StorageMultiple(OpenShift):
    """
    Attach and Access Disks on Virtual Machines GE script for DO316
    """

    __LAB__ = "storage-multiple"
    ...
    def start(self):
        ...
        items = [
            ...
            },
            {
                ...
                "playbook": f"ansible/{self.__LAB__}/start_cloudinit_script.yml",
                "fatal": True,
            },
            {
    ...
    def finish(self):
        ...
        items = [
            ...
            {
                "label": "Cleaning up the utility system",
                "task": self.run_playbook,
                "playbook": f"ansible/{self.__LAB__}/finish_cloudinit_script.yml",
                "fatal": True,
            },
        ]

...
#
# CHANGELOG
# * Tue May 10 2022 Natalie Lind <nlind@redhat.com>
#   - original code
...
class HAProbe(OpenShift):
    """
    HA Loadbalance GE script for DO316
    """

    __LAB__ = "ha-loadbalance"
    ...
    def start(self):
        ...
        items = [
            ...
            {
                "label": "Creating exercise virtual machines (please be patient)",
                "task": self.run_playbook,
                "playbook": f"ansible/{self.__LAB__}/servers.yml",
                "fatal": True,
            },
            {

...
#
# CHANGELOG
# * Tue Apr 12 2022 Herve Quatremain <hquatrem@redhat.com>
#   - original code
...
NAMESPACE = "advanced-maintenance"
...
class AdvancedMaintenance(OpenShift):
    """
    Advanced Maintenance GE script for DO316
    """

    __LAB__ = "advanced-maintenance"
    ...
    def start(self):
        ...
        items = [
            ...
            {
                "label": "Verifying Node Maintenance Operator is not installed",
                "task": self._delete_node_maintenance_namespace,
                "oc_client": self.oc_client,
                "fatal": True,
            },
            {
            ...
            {
                "label": "Creating the virtual machine",
    ...
    def finish(self):
        ...
        items = [
            ...
            {
                "label": "Deleting the NodeMaintenance resource",
    ...
    def _delete_ge_node_maintenance(self, item):
        ...
        try:
            ...
            item["failed"] = True
            item["msgs"] = [
                {"text": "Failed removing node maintenance maintenance-node: %s" % e}
            ]

    def _delete_node_maintenance_namespace(self, item):
        """
        Check Node Maintenance operator namespace
        """
        item["failed"] = False
        if self.resource_exists(
            "v1", "Namespace", ("openshift-workload-availability"), ""
        ):
            try:
                self.delete_resource(
                    "v1", "Namespace", ("openshift-workload-availability"), ""
                ...
                item["msgs"] = [
                    {
                        "text": "Failed removing namespace openshift-workload-availability: %s"
                        % (e,)
                    }
                ]
        return item["failed"]

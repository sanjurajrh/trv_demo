...
# CHANGELOG
#
# Apr 10 2024 Andres Hernandez <andres.hernandez@redhat.com>
# - original code
...
# List of hosts involved in that module.
# Before doing anything, the module checks that they can be reached on the network
_targets = ["utility"]
...
class NetworkReview(OpenShift):
    ...
    def start(self):
        ...
        items = [
            ...
            {
                "label": f"Confirming that the {self.__LAB__} project does not exist",
                "task": self._check_ge_namespace,
                "oc_client": self.oc_client,
                "fatal": True,
            },
            {
                "label": f"Creating the {VM_NAME} virtual machine",
    ...
    def finish(self):
        ...
        items = [
            ...
            {
                "label": f"Deleting the {self.__LAB__} project",

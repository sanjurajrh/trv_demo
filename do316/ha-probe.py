...
#
# CHANGELOG
# * Tue Apr 19 2022 Herve Quatremain <hquatrem@redhat.com>
#   - original code

"""
Grading module for DO316 ha-probe guided exercise.
This module either does start or finish for the ha-probe guided exercise.
"""
...
class HAProbe(OpenShift):
    """
    HA Probe GE script for DO316
    """
    ...
    def start(self):
        ...
        items = [
            ...
            {
                "label": "Creating the watch1 virtual machine",
                "task": self.run_playbook,
                "playbook": f"ansible/{self.__LAB__}/watch1.yml",
                "fatal": True,
            },
            {
            ...
            {
                "label": "Creating the service and the route resources",
                "task": self.run_playbook,

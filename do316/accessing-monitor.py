...
#
# CHANGELOG
# * Jan 24 2022 Natalie Lind <nlind@redhat.com>
#   - original code
...
NAMESPACE = ["production-vms", "developers-vms", "testing-vms"]
...
class AccessingMonitor(OpenShift):
    """
    Accessing Monitor GE script for DO316
    """

    __LAB__ = "accessing-monitor"
    ...
    def start(self):
        ...
        items = [
            ...
            {
                "label": "Creating exercise resources (be patient)",
                "task": self.run_playbook,
                "playbook": "ansible/accessing-monitor/stress-databases-vms.yml",
                "fatal": True,
            },
            {
    ...
    def finish(self):
        ...
        items = [
            ...
            {
                "label": "Deleting exercise resources",
                "task": self._delete_ge_resources,
                "fatal": True,
            },
            {
            ...
            item["msgs"] = [
                {
                    "text": "The "
                    + str(NAMESPACE)
                    + " namespace already exists, please "
                    + "delete it or run 'lab finish accessing-monitor' "
    ...
    def _delete_ge_resources(self, item):
        item["failed"] = False
        projects = ["developers-vms", "testing-vms", "production-vms", "vm-images"]
        for x in projects:
            try:

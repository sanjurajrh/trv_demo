...
#
# CHANGELOG
# * Jan 18 2022 Natalie Lind <nlind@redhat.com>
#   - original code

"""
Grading module for DO316 virtualization-deploy guided exercise.
This module either does start or finish for the virtualization-deploy guided exercise.
"""
...
class VirtualizationDeploy(OpenShift):
    """
    Virtualization Deploy GE script for DO316
    """

    __LAB__ = "virtualization-deploy"
    ...
    def start(self):
        ...
        items = [
            ...
            {
                "label": "Installing exercise resources",

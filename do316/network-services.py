...
# * Dec 17 2021 Natalie Lind <nlind@redhat.com>
#   - original code

"""
Grading module for DO316 network-services guided exercise.
This module either does start or finish for the network-services guided exercise.
"""
...
class NetworkServices(OpenShift):
    """
    Network Services GE script for DO316
    """

    __LAB__ = "network-services"
    ...
    def start(self):
        ...
        items = [
            ...
            {
                "label": "Creating mariadb-client vm",
                "task": self.run_playbook,
                "playbook": f"ansible/{self.__LAB__}/mariadb-client.yml",
                "fatal": True,
            },
            {

...
#
# CHANGELOG
# * Wed Mar  2 2022 Herve Quatremain <hquatrem@redhat.com>
#   - adapt code for the specific GE
# * Dec 10 2021 Natalie Lind <nlind@redhat.com>
#   - original code

"""
Grading module for DO316 network-external guided exercise.
This module either does start or finish for the network-external guided exercise.
"""
...
class NetworkExternal(OpenShift):
    """
    Network External GE script for DO316
    """

    __LAB__ = "network-external"
    ...
    def start(self):
        ...
        items = [
            ...
            {
                "label": "Creating hello-web vm",
                "task": self.run_playbook,
                "playbook": f"ansible/{self.__LAB__}/hello-web-vm.yml",
                "fatal": True,
            },
            {
